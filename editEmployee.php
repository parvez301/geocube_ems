...
$sql = "CALL updateEmployee('".$_GET['edit_id']."','$emp_first_name','$emp_middle_name','$emp_last_name','$emp_gender','$emp_address','$emp_photo','$emp_resume',$country_code,'$emp_contact_number','$emp_account_number','$ifsc_code','$dept_id','$project_id','$joining_date','$martial_status')";
...
//fetching values from all input fields and storing them in variables
    var project_date = document.getElementById("pdate").value;
...
if(project_date.length== 0 || joining_date.length== 0 || first_name.length==0 || last_name.length==0|| address.length==0 || contact_number.length==0 || account_number.length==0){
  ...
  <div class="collapse navbar-collapse navbar-ex1-collapse">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                {
                  $singleSql = "CALL selEmployee('".$_GET['edit_id']."')";
                  ...
                  <form id="contact-form"  class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-lg-10">
                            <input type="text" maxlength="25"  class="form-control" id="fname" name="fname" value="<?php echo $singleRow['emp_f_name']; ?>" placeholder="First Name" required autofocus>
                        </div>
                        </div>
                        <div class="form-group " >
                        <label for="mname" class="col-lg-2 control-label text-left">Employee Middle Name</label>
                        <div class="col-lg-10">
                            <input type="text" maxlength="25"  class="form-control" id="mname" name="mname" value="<?php echo $singleRow['emp_mid_name']; ?>" placeholder="Middle Name" >
                        </div>
                        </div>
                        <div class="form-group" >
                        <label for="lname" class="col-lg-2 control-label">Employee Last Name</label>
                        <div class="col-lg-10">
                            <input type="text" maxlength="25"  class="form-control" id="lname" name="lname" value="<?php echo $singleRow['emp_l_name']; ?>"placeholder="Last Name" required>
                        </div>
                        </div>
                         <div class="form-group" >
      ...
      <input type="radio"   name = "gender" value="<?php echo $singleRow['gender']; ?>"id="gender"> Male
   <input type="radio" value="<?php echo $singleRow['gender']; ?>" name = "gender" id="gender"> Female
                        </div>
                        </div>
                        ...
                        <div class="col-lg-10">
                            <textarea class="form-control" maxlength="150" rows="4" id="add" name="add" value="<?php echo $singleRow['address']; ?>"placeholder="Address" required></textarea>
                        </div>
                        </div>
    ...
    <optgroup label="Other countries">
        ...
        <option data-countryCode="ZW" value="263">Zimbabwe (+263)</option>
                        ...
                        <div class="col-lg-10">
                            <input type="text" maxlength="10"  class="form-control" id="cno" name="cno" value="<?php echo $singleRow['contact_number']; ?>"placeholder="Number" required>
                        </div>
                        </div>
                        ...
                        <div class="col-lg-10">
                            <input type="number" maxlength="25"  class="form-control" id="ano" name="ano" value="<?php echo $singleRow['account_number']; ?>"placeholder="Account Number" required>
                        </div>
                        </div>
                        ...
                        <div class="col-lg-10">
                            <input type="text" maxlength="25"  class="form-control" id="ifsc" name="ifsc" value="<?php echo $singleRow['bank_ifsc_code']; ?>" placeholder="IFSC" required>
                        </div>
                      </div>
                        <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <select class="form-control" name="did" id="did">
                              <option><?php echo $singleRow['dept_id']; ?></option>
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                                <option>4</option>
                        ...
                        <div class="col-lg-10">
                            <select class="form-control" name="pid" id="pid">
                              <option><?php echo $singleRow['project_id']; ?></option>
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                                <option>4</option>
                        ...
                        <div class="col-lg-10">
                            <input type="date" maxlength="25"  class="form-control" id="hid" name="hid" value="<?php echo $singleRow['joining_date']; ?>"required>
                        </div>
                        </div>
                        <div class="form-group">
